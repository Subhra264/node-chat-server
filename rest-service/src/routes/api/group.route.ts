...
Router.get(
  '/user/dashboard/:groupId/:channelId',
  authenticate,
  async (req: Request, res: Response, next: NextFunction) => {
    try {
      const dashBoardData = await GroupController.returnDashBoardData(
        req as AuthenticatedRequest,
      );
...
Router.get(
  ...
  async (req: Request, res: Response, next: NextFunction) => {
    try {
      const groupMembers = await GroupController.getGroupMembers(
        req as GroupValidatedRequest,
      );
...
Router.get(
  ...
  async (req: Request, res: Response, next: NextFunction) => {
    try {
      const groupChannels = await GroupController.getChannels(
        req as GroupValidatedRequest,
      );
...
Router.post(
  '/groups/create-invitation',
  authenticate,
  async (req: Request, res: Response, next: NextFunction) => {
    try {
      const token = await GroupController.createGroupInvitationToken(
        req as AuthenticatedRequest,
      );
