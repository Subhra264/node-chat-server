...
Router.get(
  ...
  async (req: Request, res: Response, next: NextFunction) => {
    try {
      const userFriends = await UserController.getFriendList(
...
Router.get(
  ...
  async (req: Request, res: Response, next: NextFunction) => {
    try {
      const userProfile = await UserController.getProfileData(
        req as AuthenticatedRequest,
      );
...
Router.get(
  ...
  async (req: Request, res: Response, next: NextFunction) => {
    try {
      const selfMessages = await UserController.getSelfMessages(
        req as AuthenticatedRequest,
      );
